...
from core import *
from misc import *
from datasets.osr_loader import CIFAR10_OSR, CIFAR100_OSR, SVHN_OSR, Tiny_ImageNet_OSR, MNIST_OSR
...
def getLoader(options):
    ...
    if 'cifar10' == options['dataset']:
        ...
        train_loader, test_loader, out_loader = Data.train_loader, Data.test_loader, Data.out_loader
    elif 'mnist' in options['dataset']:
        options['img_size'] = 28
        mnist_data = MNIST_OSR(
            known_labels=[0,2,3,4,5,6,8,9],
            from_known=5,   # ví dụ 5
        ...
        test_loader       = mnist_data.test_known_loader
        out_loader        = mnist_data.test_unk_loader
        options['num_known'] = len(mnist_data.known)
